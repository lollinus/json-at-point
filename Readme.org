...
#+begin_example
M-x package-install RET json-pretty-print-array RET
#+end_example

** Via use-package + MELPA

#+begin_src emacs-lisp
(use-package json-pretty-print-array
  :ensure t)
#+end_src
...
#+begin_src emacs-lisp
(add-to-list 'load-path "/path/to/json-pretty-print-array")
...
The package does not bind any keys by default.  A suggested configuration:

#+begin_src emacs-lisp
(with-eval-after-load 'json-pretty-print-array
