...
This package is not available on MELPA or GNU ELPA.  Install it directly
from GitHub using Emacs's built-in ~:vc~ support (Emacs 29+).

** Via use-package

#+begin_src emacs-lisp
(use-package json-at-point
  :vc (:url "https://github.com/lollinus/json-at-point" :rev :newest)
...
#+begin_src shell
git clone https://github.com/lollinus/json-at-point.git ~/.emacs.d/json-at-point
#+end_src

#+begin_src emacs-lisp
(add-to-list 'load-path "~/.emacs.d/json-at-point")
